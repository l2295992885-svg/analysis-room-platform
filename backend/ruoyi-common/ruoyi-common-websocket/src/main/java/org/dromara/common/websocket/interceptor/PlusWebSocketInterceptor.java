...
import static org.dromara.common.websocket.controller.WebSocketTicketController.WS_TICKET_PREFIX;
...
public class PlusWebSocketInterceptor implements HandshakeInterceptor {
    ...
    public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler, Map<String, Object> attributes) {
        try {
            String ticket = ServletUtils.getParameter("wsTicket");
            if (StringUtils.isNotBlank(ticket)) {
                String ticketKey = WS_TICKET_PREFIX + ticket;
                ...
                String clientId = StpUtil.getExtra(tokenValue, LoginHelper.CLIENT_KEY).toString();
