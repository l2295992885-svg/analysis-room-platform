...
(
    ...
    description       varchar2(256) DEFAULT ''                                    NULL,
    token             varchar2(64)  DEFAULT 'CHANGE_ME_SNAIL_JOB_TOKEN' NULL,
...
INSERT INTO sj_group_config (namespace_id, group_name, description, token, group_status, version, group_partition, id_generator_mode, init_scene, create_dt, update_dt) VALUES ('dev', 'ruoyi_group', '', 'CHANGE_ME_SNAIL_JOB_TOKEN', 1, 1, 0, 1, 1,  sysdate, sysdate);
INSERT INTO sj_group_config (namespace_id, group_name, description, token, group_status, version, group_partition, id_generator_mode, init_scene, create_dt, update_dt) VALUES ('prod', 'ruoyi_group', '', 'CHANGE_ME_SNAIL_JOB_TOKEN', 1, 1, 0, 1, 1,  sysdate, sysdate);
