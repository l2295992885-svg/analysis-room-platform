...
(
    ...
    description       nvarchar(256) NOT NULL DEFAULT '',
    token             nvarchar(64)  NOT NULL DEFAULT 'CHANGE_ME_SNAIL_JOB_TOKEN',
...
INSERT INTO sj_group_config(namespace_id, group_name, description, token, group_status, version, group_partition, id_generator_mode, init_scene, create_dt, update_dt) VALUES (N'dev', N'ruoyi_group', N'', N'CHANGE_ME_SNAIL_JOB_TOKEN', N'1', N'1', N'0', N'1', N'1', getdate(), getdate())
GO
INSERT INTO sj_group_config(namespace_id, group_name, description, token, group_status, version, group_partition, id_generator_mode, init_scene, create_dt, update_dt) VALUES (N'prod', N'ruoyi_group', N'', N'CHANGE_ME_SNAIL_JOB_TOKEN', N'1', N'1', N'0', N'1', N'1', getdate(), getdate())
GO
