...
(
    ...
    `token`             varchar(64)         NOT NULL DEFAULT 'CHANGE_ME_SNAIL_JOB_TOKEN' COMMENT 'token',
...
INSERT INTO `sj_group_config` VALUES (1, 'dev', 'ruoyi_group', '', 'CHANGE_ME_SNAIL_JOB_TOKEN', 1, 1, 0, 1, 1,  now(), now());
INSERT INTO `sj_group_config` VALUES (2, 'prod', 'ruoyi_group', '', 'CHANGE_ME_SNAIL_JOB_TOKEN', 1, 1, 0, 1, 1,  now(), now());
